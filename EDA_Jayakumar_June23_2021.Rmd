...
#ROC and AUC - wow AUC is 92.9%!!!
epi.tree.pred.prob <- predict(epi.tree.train, oversampled_test)
pred <- prediction(epi.tree.pred.prob[, 2], oversampled_test$y)
...
bag.pred <- predict(bag.epi.train, oversampled_validate)
mean((bag.pred - oversampled_validatet$y)^2)
...
rf.pred <- predict(rf.epi.train, oversampled_validate)
mean((rf.pred - oversampled_validate$y)^2)
```
