...
```{r Extreme random trees/Extra Trees Classifier}
library(extraTrees)
library(tidyverse)



oversampled_train_x<-oversampled_train[ c(1:178)]
oversampled_train_y<-oversampled_train$y

oversampled_validate_x<-oversampled_validate[ c(1:178)]
oversampled_validate_y<-oversampled_validate$y

oversampled_test_x<-oversampled_test[ c(1:178)]
oversampled_test_y<-oversampled_test$y



et<- extraTrees(oversampled_train_x, oversampled_train_y)
yhat<- predict(et, oversampled_validate_x)
  ## accuracy
mean(oversampled_validate_y == yhat)


  ## class probabilities
# yprob = predict(et, oversampled_validate_x, probability=TRUE)
# head(yprob)

```

Need to verify more about hyperparameters (in python). Need another week for this. 
